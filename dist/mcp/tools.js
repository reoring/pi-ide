...
function logMCP(entry) {
    try {
        ...
        appendFileSync(join(LOG_DIR, "code-calls.log"), JSON.stringify({
...
export function registerAllTools(server, graph, projectRoot) {
    ...
    server.registerTool("code_impact", {
    ...
    server.registerTool("code_file_detail", {
    ...
    server.registerTool("code_call_chain", {
    ...
    server.registerTool("code_hover", {
    ...
    server.registerTool("code_find_tests", {
    ...
    server.registerTool("code_hotspots", {
    ...
    server.registerTool("code_verify", {
    ...
    server.registerTool("code_safe_delete", {
